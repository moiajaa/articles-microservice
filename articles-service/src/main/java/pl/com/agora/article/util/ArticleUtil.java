...
public class ArticleUtil {
    ...
    public static String removeSpecialTags(String originalContent, boolean removeHtml) {
        final String withoutEscaping = originalContent.replaceAll("\\\\\"", "\"").replaceAll("\\\\n", "\n");
        if (removeHtml) {
            return withoutEscaping.replaceAll("<.+?>", "");
        }
        return withoutEscaping;
    }
}
